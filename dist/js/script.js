...
const cardsId = [0, 1, 2, 3, 4, 5, 6, 7, 8];
const cardIdDuplicado = [...cardsId, ...cardsId];
const startContainer = document.querySelector(".start");
const buttonStart = document.querySelector(".start p");
const levelSelect = document.querySelector(".jogo-nivel");
const resetButton = document.querySelectorAll(".modalButton");
function startGame() {
